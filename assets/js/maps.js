...
var marker = new google.maps.Marker({
  ...
  var markerCluster = new MarkerClusterer(map, markers, {
    ...
    var locations = [
        ...
        { lat: 52.40949, lng: -1.51283, info:'<h2>West Orchards Shopping Centre</h2><br><h3>Address:</h3>Smithford Way<br>Coventry<br>CV1 1QX<br><h3>Amenities:</h3><li>Pushchair accessible cubicle</li><li>Handsfree flush</li> <li>Baby change accessible to all</li><li>Only accessible on foot</li>',  },
        { lat: 52.40876, lng: -1.50801, info:'<h2>Coventry Cathedral</h2><br><h3>Address:</h3>Priory Street<br>Coventry<br>CV1 5FB<br><h3>Amenities:</h3><li>Not accessible to pushchairs</li><li>No handsfree flush</li> <li>No baby change facilities</li><li>Accessible by car</li>',  },
        ...
        { lat: 52.40785, lng: -1.50743, info:'<h2>Herbert Art Gallery</h2><br><h3>Address:</h3>Jordan Well<br>Coventry<br>CV1 5QP<br><h3>Amenities:</h3><li>Pushchair accessible cubicle</li><li>Handsfree flush</li> <li>Baby change accessible to all</li><li>Accessible by car</li>',  },
        ...
        { lat: 52.40658, lng: -1.51267, info:'<h2>City Arcade Public Toilets</h2><br><h3>Address:</h3>City Arcade<br>Coventry<br>CV1 3HX<br><h3>Amenities:</h3><li>Pushchair accessible cubicle</li><li>Handsfree flush</li> <li>Baby change accessible to all</li><li>Only accessible on foot</li>',  },
        { lat: 52.40829, lng: -1.51488, info:'<h2>Lower Precinct Shopping Centre Public Toilets</h2><br><h3>Address:</h3>Lower Precinct Shopping Centre<br>Coventry<br>CV1 1NQ<br><h3>Amenities:</h3><li>Pushchair accessible cubicle</li><li>Handsfree flush</li> <li>Baby change within female toilet</li><li>Only accessible on foot</li>',  },
    ];
